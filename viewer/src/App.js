...
function initialModelUrl(sessionId) {
...
export default function App() {
    ...
    return (_jsxs("div", { style: {
            ...
            height: "100vh",
            overflow: "hidden",
            background: "radial-gradient(circle at top, rgba(88, 109, 143, 0.24), transparent 32%), linear-gradient(180deg, #161a22 0%, #0d1015 100%)",
        }, children: [_jsx(Scene, {}), _jsx(ViewerHUD, {})] }));
}
